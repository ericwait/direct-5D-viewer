...
DEF_MEX_COMMAND(MoveDown)
DEF_MEX_COMMAND(MoveLeft)
DEF_MEX_COMMAND(MoveRight)
DEF_MEX_COMMAND(MoveUp)
...
DEF_MEX_COMMAND(ZoomDecrement)
DEF_MEX_COMMAND(ZoomIncrement)
END_MEX_COMMANDS